...
class VrmlData_Node(Standard_Transient):
	@staticmethod
	def GlobalIndent(self) -> int: ...
	def IsDefault(self) -> bool: ...
	def Name(self) -> str: ...
	@staticmethod
	def OK(self, theStat: VrmlData_ErrorStatus) -> bool: ...
	@staticmethod
	def OK(self, outStat: VrmlData_ErrorStatus, theStat: VrmlData_ErrorStatus) -> bool: ...
	def Read(self, theBuffer: VrmlData_InBuffer) -> VrmlData_ErrorStatus: ...
	@staticmethod
	def ReadBoolean(self, theBuffer: VrmlData_InBuffer) -> Tuple[VrmlData_ErrorStatus, bool]: ...
	def ReadNode(self, theBuffer: VrmlData_InBuffer, theNode: VrmlData_Node, Type: Optional[Standard_Type]) -> VrmlData_ErrorStatus: ...
	@staticmethod
	def ReadString(self, theBuffer: VrmlData_InBuffer, theRes: TCollection_AsciiString) -> VrmlData_ErrorStatus: ...
...
class VrmlData_Scene:
	def AddNode(self, theN: VrmlData_Node, isTopLevel: Optional[bool]) -> VrmlData_Node: ...
	def Allocator(self) -> NCollection_IncAllocator: ...
	def FindNode(self, theName: str, theType: Optional[Standard_Type]) -> VrmlData_Node: ...
	...
	@staticmethod
	def ReadLine(self, theBuffer: VrmlData_InBuffer) -> VrmlData_ErrorStatus: ...
	def ReadReal(self, theBuffer: VrmlData_InBuffer, isApplyScale: bool, isOnlyPositive: bool) -> Tuple[VrmlData_ErrorStatus, float]: ...
	@staticmethod
	def ReadWord(self, theBuffer: VrmlData_InBuffer, theStr: TCollection_AsciiString) -> VrmlData_ErrorStatus: ...
	...
	def WriteLine(self, theLine0: str, theLine1: Optional[str], theIndent: Optional[int]) -> VrmlData_ErrorStatus: ...
	def WriteXYZ(self, theXYZ: gp_XYZ, isScale: bool, thePostfix: Optional[str]) -> VrmlData_ErrorStatus: ...

class VrmlData_ShapeConvert:
	def __init__(self, theScene: VrmlData_Scene, theScale: Optional[float]) -> None: ...
	def AddShape(self, theShape: TopoDS_Shape, theName: Optional[str]) -> None: ...
	def Convert(self, theExtractFaces: bool, theExtractEdges: bool, theDeflection: Optional[float], theDeflAngle: Optional[float]) -> None: ...
...
class VrmlData_Group(VrmlData_Node):
	@overload
	def __init__(self, isTransform: Optional[bool]) -> None: ...
	@overload
	def __init__(self, theScene: VrmlData_Scene, theName: str, isTransform: Optional[bool]) -> None: ...
...
class VrmlData_Material(VrmlData_Node):
	...
	def __init__(self) -> None: ...
	@overload
	def __init__(self, theScene: VrmlData_Scene, theName: str, theAmbientIntensity: Optional[float], theShininess: Optional[float], theTransparency: Optional[float]) -> None: ...
...
class VrmlData_UnknownNode(VrmlData_Node):
	...
	def __init__(self) -> None: ...
	@overload
	def __init__(self, theScene: VrmlData_Scene, theName: Optional[str], theTitle: Optional[str]) -> None: ...
...
class VrmlData_Box(VrmlData_Geometry):
	...
	def __init__(self) -> None: ...
	@overload
	def __init__(self, theScene: VrmlData_Scene, theName: str, sizeX: Optional[float], sizeY: Optional[float], sizeZ: Optional[float]) -> None: ...
	def Clone(self, theOther: VrmlData_Node) -> VrmlData_Node: ...
	def Read(self, theBuffer: VrmlData_InBuffer) -> VrmlData_ErrorStatus: ...
...
class VrmlData_Cone(VrmlData_Geometry):
	...
	def __init__(self) -> None: ...
	@overload
	def __init__(self, theScene: VrmlData_Scene, theName: str, theBottomRadius: Optional[float], theHeight: Optional[float]) -> None: ...
...
class VrmlData_Cylinder(VrmlData_Geometry):
	...
	def __init__(self) -> None: ...
	@overload
	def __init__(self, theScene: VrmlData_Scene, theName: str, theRadius: Optional[float], theHeight: Optional[float]) -> None: ...
	def Clone(self, theOther: VrmlData_Node) -> VrmlData_Node: ...
	def HasBottom(self) -> bool: ...
	def HasSide(self) -> bool: ...
...
class VrmlData_ImageTexture(VrmlData_Texture):
	...
	def __init__(self) -> None: ...
	@overload
	def __init__(self, theScene: VrmlData_Scene, theName: str, theURL: Optional[str], theRepS: Optional[bool], theRepT: Optional[bool]) -> None: ...
	def Clone(self, theOther: VrmlData_Node) -> VrmlData_Node: ...
	def Read(self, theBuffer: VrmlData_InBuffer) -> VrmlData_ErrorStatus: ...
	def URL(self) -> False: ...
	def Write(self, thePrefix: str) -> VrmlData_ErrorStatus: ...
...
class VrmlData_IndexedLineSet(VrmlData_Geometry):
	...
	def __init__(self) -> None: ...
	@overload
	def __init__(self, theScene: VrmlData_Scene, theName: str, isColorPerVertex: Optional[bool]) -> None: ...
...
class VrmlData_Sphere(VrmlData_Geometry):
	...
	def __init__(self) -> None: ...
	@overload
	def __init__(self, theScene: VrmlData_Scene, theName: str, theRadius: Optional[float]) -> None: ...
	def Clone(self, theOther: VrmlData_Node) -> VrmlData_Node: ...
	def Radius(self) -> float: ...
	def Read(self, theBuffer: VrmlData_InBuffer) -> VrmlData_ErrorStatus: ...
	def SetRadius(self, theRadius: float) -> None: ...
...
class VrmlData_IndexedFaceSet(VrmlData_Faceted):
	...
	def __init__(self) -> None: ...
	@overload
	def __init__(self, theScene: VrmlData_Scene, theName: str, isCCW: Optional[bool], isSolid: Optional[bool], isConvex: Optional[bool], theCreaseAngle: Optional[float]) -> None: ...
	def ArrayColorInd(self, arrColorInd: int) -> False: ...
