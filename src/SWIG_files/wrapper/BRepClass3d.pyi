...
class BRepClass3d_SolidExplorer:
	...
	@staticmethod
	def FindAPointInTheFace(self, F: TopoDS_Face, P: gp_Pnt) -> Tuple[bool, float]: ...
	@staticmethod
	def FindAPointInTheFace(self, F: TopoDS_Face, P: gp_Pnt) -> Tuple[bool, float, float, float]: ...
	@staticmethod
	def FindAPointInTheFace(self, F: TopoDS_Face, P: gp_Pnt, theVecD1U: gp_Vec, theVecD1V: gp_Vec) -> Tuple[bool, float, float, float]: ...
	@staticmethod
	def FindAPointInTheFace(self, F: TopoDS_Face, P: gp_Pnt) -> Tuple[bool, float, float]: ...
	@staticmethod
	def FindAPointInTheFace(self, F: TopoDS_Face, P: gp_Pnt) -> bool: ...
	@staticmethod
	def FindAPointInTheFace(self, F: TopoDS_Face) -> Tuple[bool, float, float]: ...
