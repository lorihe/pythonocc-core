...
class FairCurve_Batten:
	...
	def Compute(self, NbIterations: Optional[int], Tolerance: Optional[float]) -> Tuple[bool, FairCurve_AnalysisCode]: ...
...
class FairCurve_Newton(math_NewtonMinimum):
	def __init__(self, theFunction: math_MultipleVarFunctionWithHessian, theSpatialTolerance: Optional[float], theCriteriumTolerance: Optional[float], theNbIterations: Optional[int], theConvexity: Optional[float], theWithSingularity: Optional[bool]) -> None: ...
	def IsConverged(self) -> bool: ...

class FairCurve_DistributionOfJerk(FairCurve_DistributionOfEnergy):
	def __init__(self, BSplOrder: int, FlatKnots: TColStd_HArray1OfReal, Poles: TColgp_HArray1OfPnt2d, DerivativeOrder: int, Law: FairCurve_BattenLaw, NbValAux: Optional[int]) -> None: ...
...
class FairCurve_DistributionOfTension(FairCurve_DistributionOfEnergy):
	def __init__(self, BSplOrder: int, FlatKnots: TColStd_HArray1OfReal, Poles: TColgp_HArray1OfPnt2d, DerivativeOrder: int, LengthSliding: float, Law: FairCurve_BattenLaw, NbValAux: Optional[int], Uniform: Optional[bool]) -> None: ...
	def SetLengthSliding(self, LengthSliding: float) -> None: ...
	def Value(self, X: math_Vector, F: math_Vector) -> bool: ...

class FairCurve_EnergyOfBatten(FairCurve_Energy):
	def __init__(self, BSplOrder: int, FlatKnots: TColStd_HArray1OfReal, Poles: TColgp_HArray1OfPnt2d, ContrOrder1: int, ContrOrder2: int, Law: FairCurve_BattenLaw, LengthSliding: float, FreeSliding: Optional[bool], Angle1: Optional[float], Angle2: Optional[float]) -> None: ...
	def LengthSliding(self) -> float: ...
	def Status(self) -> FairCurve_AnalysisCode: ...
	def Variable(self, X: math_Vector) -> bool: ...

class FairCurve_EnergyOfMVC(FairCurve_Energy):
	def __init__(self, BSplOrder: int, FlatKnots: TColStd_HArray1OfReal, Poles: TColgp_HArray1OfPnt2d, ContrOrder1: int, ContrOrder2: int, Law: FairCurve_BattenLaw, PhysicalRatio: float, LengthSliding: float, FreeSliding: Optional[bool], Angle1: Optional[float], Angle2: Optional[float], Curvature1: Optional[float], Curvature2: Optional[float]) -> None: ...
	def LengthSliding(self) -> float: ...
	def Status(self) -> FairCurve_AnalysisCode: ...
	def Variable(self, X: math_Vector) -> bool: ...

class FairCurve_MinimalVariation(FairCurve_Batten):
	def __init__(self, P1: gp_Pnt2d, P2: gp_Pnt2d, Heigth: float, Slope: Optional[float], PhysicalRatio: Optional[float]) -> None: ...
	def Compute(self, NbIterations: Optional[int], Tolerance: Optional[float]) -> Tuple[bool, FairCurve_AnalysisCode]: ...
