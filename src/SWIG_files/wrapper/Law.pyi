...
class Law:
	...
	@staticmethod
	def MixBnd(self, Degree: int, Knots: TColStd_Array1OfReal, Mults: TColStd_Array1OfInteger, Lin: Law_Linear) -> TColStd_HArray1OfReal: ...
	@staticmethod
	def MixTgt(self, Degree: int, Knots: TColStd_Array1OfReal, Mults: TColStd_Array1OfInteger, NulOnTheRight: bool, Index: int) -> TColStd_HArray1OfReal: ...
	@staticmethod
	def Reparametrize(self, Curve: Adaptor3d_Curve, First: float, Last: float, HasDF: bool, HasDL: bool, DFirst: float, DLast: float, Rev: bool, NbPoints: int) -> Law_BSpline: ...
	@staticmethod
	def Scale(self, First: float, Last: float, HasF: bool, HasL: bool, VFirst: float, VLast: float) -> Law_BSpline: ...
	@staticmethod
	def ScaleCub(self, First: float, Last: float, HasF: bool, HasL: bool, VFirst: float, VLast: float) -> Law_BSpline: ...

class Law_BSpline(Standard_Transient):
	@overload
	def __init__(self, Poles: TColStd_Array1OfReal, Knots: TColStd_Array1OfReal, Multiplicities: TColStd_Array1OfInteger, Degree: int, Periodic: Optional[bool]) -> None: ...
	@overload
	def __init__(self, Poles: TColStd_Array1OfReal, Weights: TColStd_Array1OfReal, Knots: TColStd_Array1OfReal, Multiplicities: TColStd_Array1OfInteger, Degree: int, Periodic: Optional[bool]) -> None: ...
...
class Law_Interpol(Law_BSpFunc):
	def __init__(self) -> None: ...
	def Set(self, ParAndRad: TColgp_Array1OfPnt2d, Periodic: Optional[bool]) -> None: ...
	def Set(self, ParAndRad: TColgp_Array1OfPnt2d, Dd: float, Df: float, Periodic: Optional[bool]) -> None: ...
	def SetInRelative(self, ParAndRad: TColgp_Array1OfPnt2d, Ud: float, Uf: float, Periodic: Optional[bool]) -> None: ...
	def SetInRelative(self, ParAndRad: TColgp_Array1OfPnt2d, Ud: float, Uf: float, Dd: float, Df: float, Periodic: Optional[bool]) -> None: ...
