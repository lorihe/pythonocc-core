...
class GCE2d_MakeArcOfCircle(GCE2d_Root):
	@overload
	def __init__(self, Circ: gp_Circ2d, Alpha1: float, Alpha2: float, Sense: Optional[bool]) -> None: ...
	@overload
	def __init__(self, Circ: gp_Circ2d, P: gp_Pnt2d, Alpha: float, Sense: Optional[bool]) -> None: ...
	@overload
	def __init__(self, Circ: gp_Circ2d, P1: gp_Pnt2d, P2: gp_Pnt2d, Sense: Optional[bool]) -> None: ...
	@overload
...
class GCE2d_MakeArcOfEllipse(GCE2d_Root):
	@overload
	def __init__(self, Elips: gp_Elips2d, Alpha1: float, Alpha2: float, Sense: Optional[bool]) -> None: ...
	@overload
	def __init__(self, Elips: gp_Elips2d, P: gp_Pnt2d, Alpha: float, Sense: Optional[bool]) -> None: ...
	@overload
	def __init__(self, Elips: gp_Elips2d, P1: gp_Pnt2d, P2: gp_Pnt2d, Sense: Optional[bool]) -> None: ...
	def Value(self) -> Geom2d_TrimmedCurve: ...

class GCE2d_MakeArcOfHyperbola(GCE2d_Root):
	@overload
	def __init__(self, Hypr: gp_Hypr2d, Alpha1: float, Alpha2: float, Sense: Optional[bool]) -> None: ...
	@overload
	def __init__(self, Hypr: gp_Hypr2d, P: gp_Pnt2d, Alpha: float, Sense: Optional[bool]) -> None: ...
	@overload
	def __init__(self, Hypr: gp_Hypr2d, P1: gp_Pnt2d, P2: gp_Pnt2d, Sense: Optional[bool]) -> None: ...
	def Value(self) -> Geom2d_TrimmedCurve: ...

class GCE2d_MakeArcOfParabola(GCE2d_Root):
	@overload
	def __init__(self, Parab: gp_Parab2d, Alpha1: float, Alpha2: float, Sense: Optional[bool]) -> None: ...
	@overload
	def __init__(self, Parab: gp_Parab2d, P: gp_Pnt2d, Alpha: float, Sense: Optional[bool]) -> None: ...
	@overload
	def __init__(self, Parab: gp_Parab2d, P1: gp_Pnt2d, P2: gp_Pnt2d, Sense: Optional[bool]) -> None: ...
	def Value(self) -> Geom2d_TrimmedCurve: ...
...
class GCE2d_MakeCircle(GCE2d_Root):
	...
	def __init__(self, P1: gp_Pnt2d, P2: gp_Pnt2d, P3: gp_Pnt2d) -> None: ...
	@overload
	def __init__(self, P: gp_Pnt2d, Radius: float, Sense: Optional[bool]) -> None: ...
	@overload
