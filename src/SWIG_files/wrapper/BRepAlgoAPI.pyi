...
class BRepAlgoAPI_Check(BOPAlgo_Options):
	...
	@overload
	def __init__(self, theS: TopoDS_Shape, bTestSE: Optional[bool], bTestSI: Optional[bool]) -> None: ...
	@overload
	def __init__(self, theS1: TopoDS_Shape, theS2: TopoDS_Shape, theOp: Optional[BOPAlgo_Operation], bTestSE: Optional[bool], bTestSI: Optional[bool]) -> None: ...
	def IsValid(self) -> bool: ...
	def Perform(self) -> None: ...
	def Result(self) -> BOPAlgo_ListOfCheckResult: ...
	def SetData(self, theS: TopoDS_Shape, bTestSE: Optional[bool], bTestSI: Optional[bool]) -> None: ...
	def SetData(self, theS1: TopoDS_Shape, theS2: TopoDS_Shape, theOp: Optional[BOPAlgo_Operation], bTestSE: Optional[bool], bTestSI: Optional[bool]) -> None: ...
...
class BRepAlgoAPI_BuilderAlgo(BRepAlgoAPI_Algo):
	...
	def SimplifyResult(self, theUnifyEdges: Optional[bool], theUnifyFaces: Optional[bool], theAngularTol: Optional[float]) -> None: ...
...
class BRepAlgoAPI_Cut(BRepAlgoAPI_BooleanOperation):
	...
	def __init__(self, S1: TopoDS_Shape, S2: TopoDS_Shape) -> None: ...
	@overload
	def __init__(self, S1: TopoDS_Shape, S2: TopoDS_Shape, aDSF: BOPAlgo_PaveFiller, bFWD: Optional[bool]) -> None: ...
...
class BRepAlgoAPI_Section(BRepAlgoAPI_BooleanOperation):
	...
	def __init__(self, PF: BOPAlgo_PaveFiller) -> None: ...
	@overload
	def __init__(self, S1: TopoDS_Shape, S2: TopoDS_Shape, PerformNow: Optional[bool]) -> None: ...
	@overload
	def __init__(self, S1: TopoDS_Shape, S2: TopoDS_Shape, aDSF: BOPAlgo_PaveFiller, PerformNow: Optional[bool]) -> None: ...
	@overload
	def __init__(self, S1: TopoDS_Shape, Pl: gp_Pln, PerformNow: Optional[bool]) -> None: ...
	@overload
	def __init__(self, S1: TopoDS_Shape, Sf: Geom_Surface, PerformNow: Optional[bool]) -> None: ...
	@overload
	def __init__(self, Sf: Geom_Surface, S2: TopoDS_Shape, PerformNow: Optional[bool]) -> None: ...
	@overload
