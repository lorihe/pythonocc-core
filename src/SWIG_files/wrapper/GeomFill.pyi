...
class GeomFill:
	...
	@staticmethod
	def GetCircle(self, TConv: Convert_ParameterisationType, ns1: gp_Vec, ns2: gp_Vec, dn1w: gp_Vec, dn2w: gp_Vec, nplan: gp_Vec, dnplan: gp_Vec, pts1: gp_Pnt, pts2: gp_Pnt, tang1: gp_Vec, tang2: gp_Vec, Rayon: float, DRayon: float, Center: gp_Pnt, DCenter: gp_Vec, Poles: TColgp_Array1OfPnt, DPoles: TColgp_Array1OfVec, Weigths: TColStd_Array1OfReal, DWeigths: TColStd_Array1OfReal) -> bool: ...
	@staticmethod
	def GetCircle(self, TConv: Convert_ParameterisationType, ns1: gp_Vec, ns2: gp_Vec, dn1w: gp_Vec, dn2w: gp_Vec, d2n1w: gp_Vec, d2n2w: gp_Vec, nplan: gp_Vec, dnplan: gp_Vec, d2nplan: gp_Vec, pts1: gp_Pnt, pts2: gp_Pnt, tang1: gp_Vec, tang2: gp_Vec, Dtang1: gp_Vec, Dtang2: gp_Vec, Rayon: float, DRayon: float, D2Rayon: float, Center: gp_Pnt, DCenter: gp_Vec, D2Center: gp_Vec, Poles: TColgp_Array1OfPnt, DPoles: TColgp_Array1OfVec, D2Poles: TColgp_Array1OfVec, Weigths: TColStd_Array1OfReal, DWeigths: TColStd_Array1OfReal, D2Weigths: TColStd_Array1OfReal) -> bool: ...
	@staticmethod
	def GetMinimalWeights(self, TConv: Convert_ParameterisationType, AngleMin: float, AngleMax: float, Weigths: TColStd_Array1OfReal) -> None: ...
	@staticmethod
	def GetShape(self, MaxAng: float, TypeConv: Convert_ParameterisationType) -> Tuple[int, int, int]: ...
	@staticmethod
	def GetTolerance(self, TConv: Convert_ParameterisationType, AngleMin: float, Radius: float, AngularTol: float, SpatialTol: float) -> float: ...
	@staticmethod
	def Knots(self, TypeConv: Convert_ParameterisationType, TKnots: TColStd_Array1OfReal) -> None: ...
	@staticmethod
	def Mults(self, TypeConv: Convert_ParameterisationType, TMults: TColStd_Array1OfInteger) -> None: ...
	@staticmethod
	def Surface(self, Curve1: Geom_Curve, Curve2: Geom_Curve) -> Geom_Surface: ...
...
class GeomFill_AppSurf(AppBlend_Approx):
	...
	def Perform(self, Lin: GeomFill_Line, SecGen: GeomFill_SectionGenerator, SpApprox: Optional[bool]) -> None: ...
...
class GeomFill_AppSweep(AppBlend_Approx):
	...
	def NbCurves2d(self) -> int: ...
	def ParType(self) -> Approx_ParametrizationType: ...
	def Perform(self, Lin: GeomFill_Line, SecGen: GeomFill_SweepSectionGenerator, SpApprox: Optional[bool]) -> None: ...
...
class GeomFill_CircularBlendFunc(Approx_SweepFunction):
	def __init__(self, Path: Adaptor3d_HCurve, Curve1: Adaptor3d_HCurve, Curve2: Adaptor3d_HCurve, Radius: float, Polynomial: Optional[bool]) -> None: ...
...
class GeomFill_ConstrainedFilling:
	...
	def Init(self, B1: GeomFill_Boundary, B2: GeomFill_Boundary, B3: GeomFill_Boundary, NoCheck: Optional[bool]) -> None: ...
	def Init(self, B1: GeomFill_Boundary, B2: GeomFill_Boundary, B3: GeomFill_Boundary, B4: GeomFill_Boundary, NoCheck: Optional[bool]) -> None: ...
...
class GeomFill_FunctionGuide(math_FunctionSetWithDerivatives):
	def __init__(self, S: GeomFill_SectionLaw, Guide: Adaptor3d_HCurve, ParamOnLaw: Optional[float]) -> None: ...
...
class GeomFill_Pipe:
	...
	@overload
	def __init__(self, Path: Geom_Curve, FirstSect: Geom_Curve, Option: Optional[GeomFill_Trihedron]) -> None: ...
	@overload
	...
	def Init(self, Path: Geom_Curve, FirstSect: Geom_Curve, Option: Optional[GeomFill_Trihedron]) -> None: ...
	...
	def IsDone(self) -> bool: ...
	def Perform(self, WithParameters: Optional[bool], myPolynomial: Optional[bool]) -> None: ...
	def Perform(self, Tol: float, Polynomial: bool, Conti: Optional[GeomAbs_Shape], MaxDegree: Optional[int], NbMaxSegment: Optional[int]) -> None: ...
...
class GeomFill_SectionPlacement:
	...
	def Transformation(self, WithTranslation: bool, WithCorrection: Optional[bool]) -> gp_Trsf: ...
...
class GeomFill_Sweep:
	def __init__(self, Location: GeomFill_LocationLaw, WithKpart: Optional[bool]) -> None: ...
	def Build(self, Section: GeomFill_SectionLaw, Methode: Optional[GeomFill_ApproxStyle], Continuity: Optional[GeomAbs_Shape], Degmax: Optional[int], Segmax: Optional[int]) -> None: ...
...
class GeomFill_UniformSection(GeomFill_SectionLaw):
	def __init__(self, C: Geom_Curve, FirstParameter: Optional[float], LastParameter: Optional[float]) -> None: ...
	def BSplineSurface(self) -> Geom_BSplineSurface: ...
	def BarycentreOfSurf(self) -> gp_Pnt: ...
	def ConstantSection(self) -> Geom_Curve: ...
	def D0(self, Param: float, Poles: TColgp_Array1OfPnt, Weigths: TColStd_Array1OfReal) -> bool: ...
