...
class STEPConstruct:
	...
	@staticmethod
	def FindEntity(self, FinderProcess: Transfer_FinderProcess, Shape: TopoDS_Shape) -> StepRepr_RepresentationItem: ...
	@staticmethod
	def FindEntity(self, FinderProcess: Transfer_FinderProcess, Shape: TopoDS_Shape, Loc: TopLoc_Location) -> StepRepr_RepresentationItem: ...
	@staticmethod
	def FindShape(self, TransientProcess: Transfer_TransientProcess, item: StepRepr_RepresentationItem) -> TopoDS_Shape: ...
...
class STEPConstruct_Assembly:
	def __init__(self) -> None: ...
	@staticmethod
	def CheckSRRReversesNAUO(self, theGraph: Interface_Graph, CDSR: StepShape_ContextDependentShapeRepresentation) -> bool: ...
...
class STEPConstruct_PointHasher:
	@staticmethod
	def HashCode(self, thePoint: gp_Pnt, theUpperBound: int) -> int: ...
	@staticmethod
	def IsEqual(self, Point1: gp_Pnt, Point2: gp_Pnt) -> bool: ...
...
class STEPConstruct_UnitContext:
	...
	@staticmethod
	def ConvertSiPrefix(self, aPrefix: StepBasic_SiPrefix) -> float: ...
...
class STEPConstruct_Styles(STEPConstruct_Tool):
	...
	@staticmethod
	def DecodeColor(self, Colour: StepVisual_Colour, Col: Quantity_Color) -> bool: ...
	@staticmethod
	def EncodeColor(self, Col: Quantity_Color) -> StepVisual_Colour: ...
	@staticmethod
	def EncodeColor(self, Col: Quantity_Color, DPDCs: STEPConstruct_DataMapOfAsciiStringTransient, ColRGBs: STEPConstruct_DataMapOfPointTransient) -> StepVisual_Colour: ...
