...
FrustumVert_LeftBottomNear = .FrustumVert_LeftBottomNear
FrustumVert_LeftBottomFar = .FrustumVert_LeftBottomFar
FrustumVert_LeftTopNear = .FrustumVert_LeftTopNear
FrustumVert_LeftTopFar = .FrustumVert_LeftTopFar
FrustumVert_RightBottomNear = .FrustumVert_RightBottomNear
FrustumVert_RightBottomFar = .FrustumVert_RightBottomFar
FrustumVert_RightTopNear = .FrustumVert_RightTopNear
FrustumVert_RightTopFar = .FrustumVert_RightTopFar
FrustumVerticesNB = .FrustumVerticesNB
};
/* end python proxy for enums */
