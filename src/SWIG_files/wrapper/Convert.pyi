...
class Convert_CircleToBSplineCurve(Convert_ConicToBSplineCurve):
	@overload
	def __init__(self, C: gp_Circ2d, Parameterisation: Optional[Convert_ParameterisationType]) -> None: ...
	@overload
	def __init__(self, C: gp_Circ2d, U1: float, U2: float, Parameterisation: Optional[Convert_ParameterisationType]) -> None: ...
...
class Convert_EllipseToBSplineCurve(Convert_ConicToBSplineCurve):
	@overload
	def __init__(self, E: gp_Elips2d, Parameterisation: Optional[Convert_ParameterisationType]) -> None: ...
	@overload
	def __init__(self, E: gp_Elips2d, U1: float, U2: float, Parameterisation: Optional[Convert_ParameterisationType]) -> None: ...
...
class Convert_SphereToBSplineSurface(Convert_ElementarySurfaceToBSplineSurface):
	...
	@overload
	def __init__(self, Sph: gp_Sphere, Param1: float, Param2: float, UTrim: Optional[bool]) -> None: ...
	@overload
