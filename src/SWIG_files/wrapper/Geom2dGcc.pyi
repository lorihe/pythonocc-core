...
class Geom2dGcc:
	...
	@staticmethod
	def Enclosing(self, Obj: Geom2dAdaptor_Curve) -> Geom2dGcc_QualifiedCurve: ...
	@staticmethod
	def Outside(self, Obj: Geom2dAdaptor_Curve) -> Geom2dGcc_QualifiedCurve: ...
	@staticmethod
	def Unqualified(self, Obj: Geom2dAdaptor_Curve) -> Geom2dGcc_QualifiedCurve: ...
...
class Geom2dGcc_CurveTool:
	@staticmethod
	def D1(self, C: Geom2dAdaptor_Curve, U: float, P: gp_Pnt2d, T: gp_Vec2d) -> None: ...
	@staticmethod
	def D2(self, C: Geom2dAdaptor_Curve, U: float, P: gp_Pnt2d, T: gp_Vec2d, N: gp_Vec2d) -> None: ...
	@staticmethod
	def D3(self, C: Geom2dAdaptor_Curve, U: float, P: gp_Pnt2d, T: gp_Vec2d, N: gp_Vec2d, dN: gp_Vec2d) -> None: ...
	@staticmethod
	def EpsX(self, C: Geom2dAdaptor_Curve, Tol: float) -> float: ...
	@staticmethod
	def FirstParameter(self, C: Geom2dAdaptor_Curve) -> float: ...
	@staticmethod
	def LastParameter(self, C: Geom2dAdaptor_Curve) -> float: ...
	@staticmethod
	def NbSamples(self, C: Geom2dAdaptor_Curve) -> int: ...
	@staticmethod
	def Value(self, C: Geom2dAdaptor_Curve, X: float) -> gp_Pnt2d: ...
...
class Geom2dGcc_Lin2dTanOblIter:
	def __init__(self, Qualified1: Geom2dGcc_QCurve, TheLin: gp_Lin2d, Param1: float, TolAng: float, Angle: Optional[float]) -> None: ...
