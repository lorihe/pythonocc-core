...
class IntCurve_PConicTool:
	@staticmethod
	def D1(self, C: IntCurve_PConic, U: float, P: gp_Pnt2d, T: gp_Vec2d) -> None: ...
	@staticmethod
	def D2(self, C: IntCurve_PConic, U: float, P: gp_Pnt2d, T: gp_Vec2d, N: gp_Vec2d) -> None: ...
	@staticmethod
	def EpsX(self, C: IntCurve_PConic) -> float: ...
	@staticmethod
	def NbSamples(self, C: IntCurve_PConic) -> int: ...
	@staticmethod
	def NbSamples(self, C: IntCurve_PConic, U0: float, U1: float) -> int: ...
	@staticmethod
	def Value(self, C: IntCurve_PConic, X: float) -> gp_Pnt2d: ...

class IntCurve_ProjectOnPConicTool:
	@staticmethod
	def FindParameter(self, C: IntCurve_PConic, Pnt: gp_Pnt2d, Tol: float) -> float: ...
	@staticmethod
