...
class Geom_OffsetCurve(Geom_Curve):
	def __init__(self, C: Geom_Curve, Offset: float, V: gp_Dir, isNotCheckC0: Optional[bool]) -> None: ...
	...
	def Reverse(self) -> None: ...
	def ReversedParameter(self, U: float) -> float: ...
	def SetBasisCurve(self, C: Geom_Curve, isNotCheckC0: Optional[bool]) -> None: ...
	def SetDirection(self, V: gp_Dir) -> None: ...
...
class Geom_OffsetSurface(Geom_Surface):
	def __init__(self, S: Geom_Surface, Offset: float, isNotCheckC0: Optional[bool]) -> None: ...
	def BasisSurface(self) -> Geom_Surface: ...
	def Bounds(self) -> Tuple[float, float, float, float]: ...
	def Continuity(self) -> GeomAbs_Shape: ...
	def Copy(self) -> Geom_Geometry: ...
	...
	def ParametricTransformation(self, T: gp_Trsf) -> gp_GTrsf2d: ...
	def SetBasisSurface(self, S: Geom_Surface, isNotCheckC0: Optional[bool]) -> None: ...
	def SetOffsetValue(self, D: float) -> None: ...
...
class Geom_BSplineCurve(Geom_BoundedCurve):
	@overload
	def __init__(self, Poles: TColgp_Array1OfPnt, Knots: TColStd_Array1OfReal, Multiplicities: TColStd_Array1OfInteger, Degree: int, Periodic: Optional[bool]) -> None: ...
	@overload
	def __init__(self, Poles: TColgp_Array1OfPnt, Weights: TColStd_Array1OfReal, Knots: TColStd_Array1OfReal, Multiplicities: TColStd_Array1OfInteger, Degree: int, Periodic: Optional[bool], CheckRational: Optional[bool]) -> None: ...
	def Continuity(self) -> GeomAbs_Shape: ...
	def Copy(self) -> Geom_Geometry: ...
	def D0(self, U: float, P: gp_Pnt) -> None: ...
	def D1(self, U: float, P: gp_Pnt, V1: gp_Vec) -> None: ...
	...
	def InsertKnot(self, U: float, M: Optional[int], ParametricTolerance: Optional[float], Add: Optional[bool]) -> None: ...
	def InsertKnots(self, Knots: TColStd_Array1OfReal, Mults: TColStd_Array1OfInteger, ParametricTolerance: Optional[float], Add: Optional[bool]) -> None: ...
	def IsCN(self, N: int) -> bool: ...
	def IsClosed(self) -> bool: ...
	...
	def LocateU(self, U: float, ParametricTolerance: float, WithKnotRepetition: Optional[bool]) -> Tuple[int, int]: ...
	@staticmethod
	...
	def Reverse(self) -> None: ...
	def ReversedParameter(self, U: float) -> float: ...
	def Segment(self, U1: float, U2: float, theTolerance: Optional[float]) -> None: ...
...
class Geom_BSplineSurface(Geom_BoundedSurface):
	@overload
	def __init__(self, Poles: TColgp_Array2OfPnt, UKnots: TColStd_Array1OfReal, VKnots: TColStd_Array1OfReal, UMults: TColStd_Array1OfInteger, VMults: TColStd_Array1OfInteger, UDegree: int, VDegree: int, UPeriodic: Optional[bool], VPeriodic: Optional[bool]) -> None: ...
	@overload
	def __init__(self, Poles: TColgp_Array2OfPnt, Weights: TColStd_Array2OfReal, UKnots: TColStd_Array1OfReal, VKnots: TColStd_Array1OfReal, UMults: TColStd_Array1OfInteger, VMults: TColStd_Array1OfInteger, UDegree: int, VDegree: int, UPeriodic: Optional[bool], VPeriodic: Optional[bool]) -> None: ...
	def Bounds(self) -> Tuple[float, float, float, float]: ...
	def CheckAndSegment(self, U1: float, U2: float, V1: float, V2: float, theUTolerance: Optional[float], theVTolerance: Optional[float]) -> None: ...
	def Continuity(self) -> GeomAbs_Shape: ...
	def Copy(self) -> Geom_Geometry: ...
	def D0(self, U: float, V: float, P: gp_Pnt) -> None: ...
	def D1(self, U: float, V: float, P: gp_Pnt, D1U: gp_Vec, D1V: gp_Vec) -> None: ...
	...
	def InsertUKnot(self, U: float, M: int, ParametricTolerance: float, Add: Optional[bool]) -> None: ...
	def InsertUKnots(self, Knots: TColStd_Array1OfReal, Mults: TColStd_Array1OfInteger, ParametricTolerance: Optional[float], Add: Optional[bool]) -> None: ...
	def InsertVKnot(self, V: float, M: int, ParametricTolerance: float, Add: Optional[bool]) -> None: ...
	def InsertVKnots(self, Knots: TColStd_Array1OfReal, Mults: TColStd_Array1OfInteger, ParametricTolerance: Optional[float], Add: Optional[bool]) -> None: ...
	def IsCNu(self, N: int) -> bool: ...
	def IsCNv(self, N: int) -> bool: ...
	def IsUClosed(self) -> bool: ...
	def IsUPeriodic(self) -> bool: ...
	...
	def LocateU(self, U: float, ParametricTolerance: float, WithKnotRepetition: Optional[bool]) -> Tuple[int, int]: ...
	def LocateV(self, V: float, ParametricTolerance: float, WithKnotRepetition: Optional[bool]) -> Tuple[int, int]: ...
	@staticmethod
	def MaxDegree(self) -> int: ...
	...
	def Segment(self, U1: float, U2: float, V1: float, V2: float, theUTolerance: Optional[float], theVTolerance: Optional[float]) -> None: ...
...
class Geom_RectangularTrimmedSurface(Geom_BoundedSurface):
	@overload
	def __init__(self, S: Geom_Surface, U1: float, U2: float, V1: float, V2: float, USense: Optional[bool], VSense: Optional[bool]) -> None: ...
	@overload
	def __init__(self, S: Geom_Surface, Param1: float, Param2: float, UTrim: bool, Sense: Optional[bool]) -> None: ...
	def BasisSurface(self) -> Geom_Surface: ...
	def Bounds(self) -> Tuple[float, float, float, float]: ...
	def Continuity(self) -> GeomAbs_Shape: ...
	def Copy(self) -> Geom_Geometry: ...
	...
	def IsVPeriodic(self) -> bool: ...
	def ParametricTransformation(self, T: gp_Trsf) -> gp_GTrsf2d: ...
	def SetTrim(self, U1: float, U2: float, V1: float, V2: float, USense: Optional[bool], VSense: Optional[bool]) -> None: ...
	def SetTrim(self, Param1: float, Param2: float, UTrim: bool, Sense: Optional[bool]) -> None: ...
	def Transform(self, T: gp_Trsf) -> None: ...
	def TransformParameters(self, T: gp_Trsf) -> Tuple[float, float]: ...
	def UIso(self, U: float) -> Geom_Curve: ...
	def UPeriod(self) -> float: ...
...
class Geom_TrimmedCurve(Geom_BoundedCurve):
	def __init__(self, C: Geom_Curve, U1: float, U2: float, Sense: Optional[bool], theAdjustPeriodic: Optional[bool]) -> None: ...
	def BasisCurve(self) -> Geom_Curve: ...
	def Continuity(self) -> GeomAbs_Shape: ...
	def Copy(self) -> Geom_Geometry: ...
	def D0(self, U: float, P: gp_Pnt) -> None: ...
	...
	def Reverse(self) -> None: ...
	def ReversedParameter(self, U: float) -> float: ...
	def SetTrim(self, U1: float, U2: float, Sense: Optional[bool], theAdjustPeriodic: Optional[bool]) -> None: ...
	def StartPoint(self) -> gp_Pnt: ...
	def Transform(self, T: gp_Trsf) -> None: ...
	def TransformedParameter(self, U: float, T: gp_Trsf) -> float: ...
