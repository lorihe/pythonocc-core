...
class ShapeProcess:
	...
	@staticmethod
	def Perform(self, context: ShapeProcess_Context, seq: str) -> bool: ...
	@staticmethod
	def RegisterOperator(self, name: str, op: ShapeProcess_Operator) -> bool: ...
...
class ShapeProcess_OperLibrary:
	@staticmethod
	def ApplyModifier(self, S: TopoDS_Shape, context: ShapeProcess_ShapeContext, M: BRepTools_Modification, map: TopTools_DataMapOfShapeShape, msg: Optional[ShapeExtend_MsgRegistrator], theMutableInput: Optional[bool]) -> TopoDS_Shape: ...
	@staticmethod
	def Init(self) -> None: ...
