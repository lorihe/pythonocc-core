...
class GProp_PGProps(GProp_GProps):
	...
	@staticmethod
	def Barycentre(self, Pnts: TColgp_Array1OfPnt) -> gp_Pnt: ...
	@staticmethod
	def Barycentre(self, Pnts: TColgp_Array2OfPnt) -> gp_Pnt: ...
	@staticmethod
	def Barycentre(self, Pnts: TColgp_Array1OfPnt, Density: TColStd_Array1OfReal, G: gp_Pnt) -> float: ...
	@staticmethod
	def Barycentre(self, Pnts: TColgp_Array2OfPnt, Density: TColStd_Array2OfReal, G: gp_Pnt) -> float: ...
