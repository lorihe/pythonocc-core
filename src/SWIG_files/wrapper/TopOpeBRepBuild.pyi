...
class TopOpeBRepBuild_AreaBuilder:
	...
	@overload
	def __init__(self, LS: TopOpeBRepBuild_LoopSet, LC: TopOpeBRepBuild_LoopClassifier, ForceClass: Optional[bool]) -> None: ...
	def ADD_LISTOFLoop_TO_LISTOFLoop(self, LOL1: TopOpeBRepBuild_ListOfLoop, LOL2: TopOpeBRepBuild_ListOfLoop, s: Optional[None], s1: Optional[None], s2: Optional[None]) -> None: ...
	def ADD_Loop_TO_LISTOFLoop(self, L: TopOpeBRepBuild_Loop, LOL: TopOpeBRepBuild_ListOfLoop, s: Optional[None]) -> None: ...
	def InitArea(self) -> int: ...
	def InitAreaBuilder(self, LS: TopOpeBRepBuild_LoopSet, LC: TopOpeBRepBuild_LoopClassifier, ForceClass: Optional[bool]) -> None: ...
	...
	def REM_Loop_FROM_LISTOFLoop(self, ITLOL: TopOpeBRepBuild_ListIteratorOfListOfLoop, LOL: TopOpeBRepBuild_ListOfLoop, s: Optional[None]) -> None: ...
...
class TopOpeBRepBuild_Builder:
	...
	@staticmethod
	def Contains(self, S: TopoDS_Shape, L: TopTools_ListOfShape) -> bool: ...
	...
	@staticmethod
	def GContains(self, S: TopoDS_Shape, L: TopTools_ListOfShape) -> bool: ...
	@staticmethod
	def GCopyList(self, Lin: TopTools_ListOfShape, i1: int, i2: int, Lou: TopTools_ListOfShape) -> None: ...
	@staticmethod
	def GCopyList(self, Lin: TopTools_ListOfShape, Lou: TopTools_ListOfShape) -> None: ...
	...
	@staticmethod
	def GTakeCommonOfDiff(self, G: TopOpeBRepBuild_GTopo) -> bool: ...
	@staticmethod
	def GTakeCommonOfSame(self, G: TopOpeBRepBuild_GTopo) -> bool: ...
	...
	@staticmethod
	def GcheckNBOUNDS(self, E: TopoDS_Shape) -> bool: ...
	def GdumpEDBU(self, EB: TopOpeBRepBuild_EdgeBuilder) -> None: ...
	def GdumpEDG(self, S: TopoDS_Shape, str: Optional[None]) -> None: ...
	def GdumpEDGVER(self, E: TopoDS_Shape, V: TopoDS_Shape, str: Optional[None]) -> None: ...
	...
	@staticmethod
	def GdumpORIPARPNT(self, o: TopAbs_Orientation, p: float, Pnt: gp_Pnt) -> None: ...
	@staticmethod
	def GdumpPNT(self, P: gp_Pnt) -> None: ...
	def GdumpSAMDOM(self, L: TopTools_ListOfShape, str: Optional[None]) -> None: ...
	def GdumpSHA(self, S: TopoDS_Shape, str: Optional[None]) -> None: ...
	def GdumpSHAORI(self, S: TopoDS_Shape, str: Optional[None]) -> None: ...
	def GdumpSHAORIGEO(self, S: TopoDS_Shape, str: Optional[None]) -> None: ...
	...
	def GdumpSHASTA(self, iS: int, T: TopAbs_State, SS: TopOpeBRepBuild_ShapeSet, a: Optional[TCollection_AsciiString], b: Optional[TCollection_AsciiString], c: Optional[TCollection_AsciiString]) -> None: ...
	...
	@staticmethod
	def KPContains(self, S: TopoDS_Shape, L: TopTools_ListOfShape) -> bool: ...
	...
	@staticmethod
	def KPls(self, S: TopoDS_Shape, T: TopAbs_ShapeEnum, L: TopTools_ListOfShape) -> int: ...
	@staticmethod
	def KPls(self, S: TopoDS_Shape, T: TopAbs_ShapeEnum) -> int: ...
	...
	def MergeEdges(self, L1: TopTools_ListOfShape, TB1: TopAbs_State, L2: TopTools_ListOfShape, TB2: TopAbs_State, onA: Optional[bool], onB: Optional[bool], onAB: Optional[bool]) -> None: ...
	def MergeFaces(self, S1: TopTools_ListOfShape, TB1: TopAbs_State, S2: TopTools_ListOfShape, TB2: TopAbs_State, onA: Optional[bool], onB: Optional[bool], onAB: Optional[bool]) -> None: ...
	...
	@staticmethod
	def Orient(self, O: TopAbs_Orientation, R: bool) -> TopAbs_Orientation: ...
	...
	@staticmethod
	def PrintCur(self, E: TopoDS_Edge) -> None: ...
	@staticmethod
	def PrintGeo(self, S: TopoDS_Shape) -> None: ...
	@staticmethod
	def PrintOri(self, S: TopoDS_Shape) -> None: ...
	@staticmethod
	def PrintPnt(self, V: TopoDS_Vertex) -> None: ...
	@staticmethod
	def PrintSur(self, F: TopoDS_Face) -> None: ...
	...
	@staticmethod
	def Reverse(self, T1: TopAbs_State, T2: TopAbs_State) -> bool: ...
	...
	@staticmethod
	def StringState(self, S: TopAbs_State) -> TCollection_AsciiString: ...
	@staticmethod
	def TopType(self, S: TopoDS_Shape) -> TopAbs_ShapeEnum: ...
...
class TopOpeBRepBuild_CorrectFace2d:
	...
	@staticmethod
	def CheckList(self, aFace: TopoDS_Face, aHeadList: TopTools_ListOfShape) -> None: ...
	def CorrectedFace(self) -> TopoDS_Face: ...
	def ErrorStatus(self) -> int: ...
	def Face(self) -> TopoDS_Face: ...
	@staticmethod
	def GetP2dFL(self, aFace: TopoDS_Face, anEdge: TopoDS_Edge, P2dF: gp_Pnt2d, P2dL: gp_Pnt2d) -> None: ...
...
class TopOpeBRepBuild_FaceBuilder:
	...
	def __init__(self) -> None: ...
	@overload
	def __init__(self, ES: TopOpeBRepBuild_WireEdgeSet, F: TopoDS_Shape, ForceClass: Optional[bool]) -> None: ...
...
class TopOpeBRepBuild_GTool:
	@staticmethod
	def GComDiff(self, s1: TopAbs_ShapeEnum, s2: TopAbs_ShapeEnum) -> TopOpeBRepBuild_GTopo: ...
	@staticmethod
	def GComSame(self, s1: TopAbs_ShapeEnum, s2: TopAbs_ShapeEnum) -> TopOpeBRepBuild_GTopo: ...
	@staticmethod
	def GComUnsh(self, s1: TopAbs_ShapeEnum, s2: TopAbs_ShapeEnum) -> TopOpeBRepBuild_GTopo: ...
	@staticmethod
	def GCutDiff(self, s1: TopAbs_ShapeEnum, s2: TopAbs_ShapeEnum) -> TopOpeBRepBuild_GTopo: ...
	@staticmethod
	def GCutSame(self, s1: TopAbs_ShapeEnum, s2: TopAbs_ShapeEnum) -> TopOpeBRepBuild_GTopo: ...
	@staticmethod
	def GCutUnsh(self, s1: TopAbs_ShapeEnum, s2: TopAbs_ShapeEnum) -> TopOpeBRepBuild_GTopo: ...
	@staticmethod
	def GFusDiff(self, s1: TopAbs_ShapeEnum, s2: TopAbs_ShapeEnum) -> TopOpeBRepBuild_GTopo: ...
	@staticmethod
	def GFusSame(self, s1: TopAbs_ShapeEnum, s2: TopAbs_ShapeEnum) -> TopOpeBRepBuild_GTopo: ...
	@staticmethod
	def GFusUnsh(self, s1: TopAbs_ShapeEnum, s2: TopAbs_ShapeEnum) -> TopOpeBRepBuild_GTopo: ...
...
class TopOpeBRepBuild_HBuilder(Standard_Transient):
	...
	def InitExtendedSectionDS(self, k: Optional[int]) -> None: ...
	def InitSection(self, k: Optional[int]) -> None: ...
	def IsKPart(self) -> int: ...
...
class TopOpeBRepBuild_ShapeSet:
	def __init__(self, SubShapeType: TopAbs_ShapeEnum, checkshape: Optional[bool]) -> None: ...
	...
	def CheckShape(self, S: TopoDS_Shape, checkgeom: Optional[bool]) -> bool: ...
...
class TopOpeBRepBuild_SolidBuilder:
	...
	def __init__(self) -> None: ...
	@overload
	def __init__(self, FS: TopOpeBRepBuild_ShellFaceSet, ForceClass: Optional[bool]) -> None: ...
	def Face(self) -> TopoDS_Shape: ...
	def InitFace(self) -> int: ...
...
class TopOpeBRepBuild_Tools:
	@staticmethod
	def CheckFaceClosed2d(self, theFace: TopoDS_Face) -> bool: ...
	@staticmethod
	def CorrectCurveOnSurface(self, aS: TopoDS_Shape, aTolMax: Optional[float]) -> None: ...
	@staticmethod
	def CorrectFace2d(self, oldFace: TopoDS_Shape, corrFace: TopoDS_Shape, aSourceShapes: TopTools_IndexedMapOfOrientedShape, aMapOfCorrect2dEdges: TopTools_IndexedDataMapOfShapeShape) -> None: ...
	@staticmethod
	def CorrectPointOnCurve(self, aS: TopoDS_Shape, aTolMax: Optional[float]) -> None: ...
	@staticmethod
	def CorrectTolerances(self, aS: TopoDS_Shape, aTolMax: Optional[float]) -> None: ...
	@staticmethod
	def FindState(self, aVertex: TopoDS_Shape, aState: TopAbs_State, aShapeEnum: TopAbs_ShapeEnum, aMapVertexEdges: TopTools_IndexedDataMapOfShapeListOfShape, aMapProcessedVertices: TopTools_MapOfShape, aMapVs: TopOpeBRepDS_DataMapOfShapeState) -> None: ...
	@staticmethod
	def FindState1(self, anEdge: TopoDS_Shape, aState: TopAbs_State, aMapEdgesFaces: TopTools_IndexedDataMapOfShapeListOfShape, aMapProcessedVertices: TopTools_MapOfShape, aMapVs: TopOpeBRepDS_DataMapOfShapeState) -> None: ...
	@staticmethod
	def FindState2(self, anEdge: TopoDS_Shape, aState: TopAbs_State, aMapEdgesFaces: TopTools_IndexedDataMapOfShapeListOfShape, aMapProcessedEdges: TopTools_MapOfShape, aMapVs: TopOpeBRepDS_DataMapOfShapeState) -> None: ...
	@staticmethod
	def FindStateThroughVertex(self, aShape: TopoDS_Shape, aShapeClassifier: TopOpeBRepTool_ShapeClassifier, aMapOfShapeWithState: TopOpeBRepDS_IndexedDataMapOfShapeWithState, anAvoidSubshMap: TopTools_MapOfShape) -> TopAbs_State: ...
	@staticmethod
	def GetAdjacentFace(self, aFaceObj: TopoDS_Shape, anEObj: TopoDS_Shape, anEdgeFaceMap: TopTools_IndexedDataMapOfShapeListOfShape, anAdjFaceObj: TopoDS_Shape) -> bool: ...
	@staticmethod
	def GetNormalInNearestPoint(self, aFace: TopoDS_Face, anEdge: TopoDS_Edge, aNormal: gp_Vec) -> None: ...
	@staticmethod
	def GetNormalToFaceOnEdge(self, aFObj: TopoDS_Face, anEdgeObj: TopoDS_Edge, aDirNormal: gp_Vec) -> None: ...
	@staticmethod
	def GetTangentToEdge(self, anEdgeObj: TopoDS_Edge, aTangent: gp_Vec) -> bool: ...
	@staticmethod
	def GetTangentToEdgeEdge(self, aFObj: TopoDS_Face, anEdgeObj: TopoDS_Edge, aOriEObj: TopoDS_Edge, aTangent: gp_Vec) -> bool: ...
	@staticmethod
	def IsDegEdgesTheSame(self, anE1: TopoDS_Shape, anE2: TopoDS_Shape) -> bool: ...
	@staticmethod
	def NormalizeFace(self, oldFace: TopoDS_Shape, corrFace: TopoDS_Shape) -> None: ...
	@staticmethod
	def PropagateState(self, aSplEdgesState: TopOpeBRepDS_DataMapOfShapeState, anEdgesToRestMap: TopTools_IndexedMapOfShape, aShapeEnum1: TopAbs_ShapeEnum, aShapeEnum2: TopAbs_ShapeEnum, aShapeClassifier: TopOpeBRepTool_ShapeClassifier, aMapOfShapeWithState: TopOpeBRepDS_IndexedDataMapOfShapeWithState, anUnkStateShapes: TopTools_MapOfShape) -> None: ...
	@staticmethod
	def PropagateStateForWires(self, aFacesToRestMap: TopTools_IndexedMapOfShape, aMapOfShapeWithState: TopOpeBRepDS_IndexedDataMapOfShapeWithState) -> None: ...
	@staticmethod
	def SpreadStateToChild(self, aShape: TopoDS_Shape, aState: TopAbs_State, aMapOfShapeWithState: TopOpeBRepDS_IndexedDataMapOfShapeWithState) -> None: ...
	@staticmethod
	def UpdateEdgeOnFace(self, aEdgeToUpdate: TopoDS_Edge, OldFace: TopoDS_Face, NewFace: TopoDS_Face) -> None: ...
	@staticmethod
	def UpdateEdgeOnPeriodicalFace(self, aEdgeToUpdate: TopoDS_Edge, OldFace: TopoDS_Face, NewFace: TopoDS_Face) -> None: ...
	@staticmethod
	def UpdatePCurves(self, aWire: TopoDS_Wire, fromFace: TopoDS_Face, toFace: TopoDS_Face) -> None: ...

class TopOpeBRepBuild_Tools2d:
	@staticmethod
	def DumpMapOfShapeVertexInfo(self, aMap: TopOpeBRepBuild_IndexedDataMapOfShapeVertexInfo) -> None: ...
	@staticmethod
	def MakeMapOfShapeVertexInfo(self, aWire: TopoDS_Wire, aMap: TopOpeBRepBuild_IndexedDataMapOfShapeVertexInfo) -> None: ...
	@staticmethod
	def Path(self, aWire: TopoDS_Wire, aResList: TopTools_ListOfShape) -> None: ...
...
class TopOpeBRepBuild_Area1dBuilder(TopOpeBRepBuild_AreaBuilder):
	...
	def __init__(self) -> None: ...
	@overload
	def __init__(self, LS: TopOpeBRepBuild_PaveSet, LC: TopOpeBRepBuild_PaveClassifier, ForceClass: Optional[bool]) -> None: ...
	def ADD_LISTOFLoop_TO_LISTOFLoop(self, LOL1: TopOpeBRepBuild_ListOfLoop, LOL2: TopOpeBRepBuild_ListOfLoop, s: Optional[None], s1: Optional[None], s2: Optional[None]) -> None: ...
	def ADD_Loop_TO_LISTOFLoop(self, L: TopOpeBRepBuild_Loop, LOL: TopOpeBRepBuild_ListOfLoop, s: Optional[None]) -> None: ...
	@staticmethod
	def DumpList(self, L: TopOpeBRepBuild_ListOfLoop) -> None: ...
	def InitAreaBuilder(self, LS: TopOpeBRepBuild_LoopSet, LC: TopOpeBRepBuild_LoopClassifier, ForceClass: Optional[bool]) -> None: ...
	def REM_Loop_FROM_LISTOFLoop(self, ITLOL: TopOpeBRepBuild_ListIteratorOfListOfLoop, LOL: TopOpeBRepBuild_ListOfLoop, s: Optional[None]) -> None: ...
...
class TopOpeBRepBuild_PaveClassifier(TopOpeBRepBuild_LoopClassifier):
	...
	@staticmethod
	def AdjustCase(self, p1: float, o: TopAbs_Orientation, first: float, period: float, tol: float) -> Tuple[float, int]: ...
...
class TopOpeBRepBuild_PaveSet(TopOpeBRepBuild_LoopSet):
	...
	@staticmethod
	def SortPave(self, Lin: TopOpeBRepBuild_ListOfPave, Lout: TopOpeBRepBuild_ListOfPave) -> None: ...

class TopOpeBRepBuild_ShellFaceSet(TopOpeBRepBuild_ShapeSet):
	@overload
	def __init__(self) -> None: ...
	@overload
	def __init__(self, S: TopoDS_Shape, Addr: Optional[None]) -> None: ...
	def AddElement(self, S: TopoDS_Shape) -> None: ...
	def AddShape(self, S: TopoDS_Shape) -> None: ...
	def AddStartElement(self, S: TopoDS_Shape) -> None: ...
	def DumpSS(self) -> None: ...
...
class TopOpeBRepBuild_WireEdgeSet(TopOpeBRepBuild_ShapeSet):
	def __init__(self, F: TopoDS_Shape, Addr: Optional[None]) -> None: ...
	def AddElement(self, S: TopoDS_Shape) -> None: ...
	def AddShape(self, S: TopoDS_Shape) -> None: ...
	def AddStartElement(self, S: TopoDS_Shape) -> None: ...
	def DumpSS(self) -> None: ...
	...
	@staticmethod
	def IsUVISO(self, E: TopoDS_Edge, F: TopoDS_Face) -> Tuple[bool, bool]: ...
	def MakeNeighboursList(self, E: TopoDS_Shape, V: TopoDS_Shape) -> TopTools_ListOfShape: ...
	def SName(self, S: TopoDS_Shape, sb: Optional[TCollection_AsciiString], sa: Optional[TCollection_AsciiString]) -> TCollection_AsciiString: ...
	def SName(self, S: TopTools_ListOfShape, sb: Optional[TCollection_AsciiString], sa: Optional[TCollection_AsciiString]) -> TCollection_AsciiString: ...
	def SNameori(self, S: TopoDS_Shape, sb: Optional[TCollection_AsciiString], sa: Optional[TCollection_AsciiString]) -> TCollection_AsciiString: ...
...
class TopOpeBRepBuild_EdgeBuilder(TopOpeBRepBuild_Area1dBuilder):
	...
	def InitEdgeBuilder(self, LS: TopOpeBRepBuild_LoopSet, LC: TopOpeBRepBuild_LoopClassifier, ForceClass: Optional[bool]) -> None: ...
...
class TopOpeBRepBuild_FaceAreaBuilder(TopOpeBRepBuild_Area2dBuilder):
	...
	@overload
	def __init__(self, LS: TopOpeBRepBuild_LoopSet, LC: TopOpeBRepBuild_LoopClassifier, ForceClass: Optional[bool]) -> None: ...
	def InitFaceAreaBuilder(self, LS: TopOpeBRepBuild_LoopSet, LC: TopOpeBRepBuild_LoopClassifier, ForceClass: Optional[bool]) -> None: ...
...
class TopOpeBRepBuild_SolidAreaBuilder(TopOpeBRepBuild_Area3dBuilder):
	...
	@overload
	def __init__(self, LS: TopOpeBRepBuild_LoopSet, LC: TopOpeBRepBuild_LoopClassifier, ForceClass: Optional[bool]) -> None: ...
	def InitSolidAreaBuilder(self, LS: TopOpeBRepBuild_LoopSet, LC: TopOpeBRepBuild_LoopClassifier, ForceClass: Optional[bool]) -> None: ...
