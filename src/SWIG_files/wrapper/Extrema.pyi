...
class Extrema_CCLocFOfLocECC(math_FunctionSetWithDerivatives):
	@overload
	def __init__(self, thetol: Optional[float]) -> None: ...
	@overload
	def __init__(self, C1: Adaptor3d_Curve, C2: Adaptor3d_Curve, thetol: Optional[float]) -> None: ...
...
class Extrema_CCLocFOfLocECC2d(math_FunctionSetWithDerivatives):
	...
	def __init__(self, thetol: Optional[float]) -> None: ...
	@overload
	def __init__(self, C1: Adaptor2d_Curve2d, C2: Adaptor2d_Curve2d, thetol: Optional[float]) -> None: ...
	def CurvePtr(self, theRank: int) -> None: ...
	def Derivatives(self, UV: math_Vector, DF: math_Matrix) -> bool: ...
	def GetStateNumber(self) -> int: ...
	def NbEquations(self) -> int: ...
...
class Extrema_Curve2dTool:
	@staticmethod
	def BSpline(self, C: Adaptor2d_Curve2d) -> Geom2d_BSplineCurve: ...
	@staticmethod
	def Bezier(self, C: Adaptor2d_Curve2d) -> Geom2d_BezierCurve: ...
	@staticmethod
	def Circle(self, C: Adaptor2d_Curve2d) -> gp_Circ2d: ...
	@staticmethod
	def Continuity(self, C: Adaptor2d_Curve2d) -> GeomAbs_Shape: ...
	@staticmethod
	def D0(self, C: Adaptor2d_Curve2d, U: float, P: gp_Pnt2d) -> None: ...
	@staticmethod
	def D1(self, C: Adaptor2d_Curve2d, U: float, P: gp_Pnt2d, V: gp_Vec2d) -> None: ...
	@staticmethod
	def D2(self, C: Adaptor2d_Curve2d, U: float, P: gp_Pnt2d, V1: gp_Vec2d, V2: gp_Vec2d) -> None: ...
	@staticmethod
	def D3(self, C: Adaptor2d_Curve2d, U: float, P: gp_Pnt2d, V1: gp_Vec2d, V2: gp_Vec2d, V3: gp_Vec2d) -> None: ...
	@staticmethod
	def DN(self, C: Adaptor2d_Curve2d, U: float, N: int) -> gp_Vec2d: ...
	@staticmethod
	def DeflCurvIntervals(self, C: Adaptor2d_Curve2d) -> TColStd_HArray1OfReal: ...
	@staticmethod
	...
	@staticmethod
	def Intervals(self, C: Adaptor2d_Curve2d, T: TColStd_Array1OfReal, S: GeomAbs_Shape) -> None: ...
	@staticmethod
	def IsClosed(self, C: Adaptor2d_Curve2d) -> bool: ...
	@staticmethod
	def IsPeriodic(self, C: Adaptor2d_Curve2d) -> bool: ...
	@staticmethod
	def IsRational(self, C: Adaptor2d_Curve2d) -> bool: ...
	@staticmethod
	def LastParameter(self, C: Adaptor2d_Curve2d) -> float: ...
	@staticmethod
	def Line(self, C: Adaptor2d_Curve2d) -> gp_Lin2d: ...
	@staticmethod
	def NbIntervals(self, C: Adaptor2d_Curve2d, S: GeomAbs_Shape) -> int: ...
	@staticmethod
	def NbKnots(self, C: Adaptor2d_Curve2d) -> int: ...
	@staticmethod
	def NbPoles(self, C: Adaptor2d_Curve2d) -> int: ...
	@staticmethod
	def Parabola(self, C: Adaptor2d_Curve2d) -> gp_Parab2d: ...
	@staticmethod
	def Period(self, C: Adaptor2d_Curve2d) -> float: ...
	@staticmethod
	def Resolution(self, C: Adaptor2d_Curve2d, R3d: float) -> float: ...
	@staticmethod
	def Value(self, C: Adaptor2d_Curve2d, U: float) -> gp_Pnt2d: ...

class Extrema_CurveTool:
	@staticmethod
	def BSpline(self, C: Adaptor3d_Curve) -> Geom_BSplineCurve: ...
	@staticmethod
	def Bezier(self, C: Adaptor3d_Curve) -> Geom_BezierCurve: ...
	@staticmethod
	def Circle(self, C: Adaptor3d_Curve) -> gp_Circ: ...
	@staticmethod
	def Continuity(self, C: Adaptor3d_Curve) -> GeomAbs_Shape: ...
	@staticmethod
	def D0(self, C: Adaptor3d_Curve, U: float, P: gp_Pnt) -> None: ...
	@staticmethod
	def D1(self, C: Adaptor3d_Curve, U: float, P: gp_Pnt, V: gp_Vec) -> None: ...
	@staticmethod
	def D2(self, C: Adaptor3d_Curve, U: float, P: gp_Pnt, V1: gp_Vec, V2: gp_Vec) -> None: ...
	@staticmethod
	def D3(self, C: Adaptor3d_Curve, U: float, P: gp_Pnt, V1: gp_Vec, V2: gp_Vec, V3: gp_Vec) -> None: ...
	@staticmethod
	def DN(self, C: Adaptor3d_Curve, U: float, N: int) -> gp_Vec: ...
	@staticmethod
	def DeflCurvIntervals(self, C: Adaptor3d_Curve) -> TColStd_HArray1OfReal: ...
	@staticmethod
	def Degree(self, C: Adaptor3d_Curve) -> int: ...
	@staticmethod
	def Ellipse(self, C: Adaptor3d_Curve) -> gp_Elips: ...
	@staticmethod
	def FirstParameter(self, C: Adaptor3d_Curve) -> float: ...
	@staticmethod
	def GetType(self, C: Adaptor3d_Curve) -> GeomAbs_CurveType: ...
	@staticmethod
	def Hyperbola(self, C: Adaptor3d_Curve) -> gp_Hypr: ...
	@staticmethod
	def Intervals(self, C: Adaptor3d_Curve, T: TColStd_Array1OfReal, S: GeomAbs_Shape) -> None: ...
	@staticmethod
	def IsPeriodic(self, C: Adaptor3d_Curve) -> bool: ...
	@staticmethod
	def IsRational(self, C: Adaptor3d_Curve) -> bool: ...
	@staticmethod
	def LastParameter(self, C: Adaptor3d_Curve) -> float: ...
	@staticmethod
	def Line(self, C: Adaptor3d_Curve) -> gp_Lin: ...
	@staticmethod
	def NbIntervals(self, C: Adaptor3d_Curve, S: GeomAbs_Shape) -> int: ...
	@staticmethod
	def NbKnots(self, C: Adaptor3d_Curve) -> int: ...
	@staticmethod
	def NbPoles(self, C: Adaptor3d_Curve) -> int: ...
	@staticmethod
	def Parabola(self, C: Adaptor3d_Curve) -> gp_Parab: ...
	@staticmethod
	def Period(self, C: Adaptor3d_Curve) -> float: ...
	@staticmethod
	def Resolution(self, C: Adaptor3d_Curve, R3d: float) -> float: ...
	@staticmethod
	def Value(self, C: Adaptor3d_Curve, U: float) -> gp_Pnt: ...
...
class Extrema_ECC:
	...
	def SquareDistance(self, N: Optional[int]) -> float: ...
...
class Extrema_ELPCOfLocateExtPC:
	...
	def __init__(self) -> None: ...
	@overload
	def __init__(self, P: gp_Pnt, C: Adaptor3d_Curve, Uinf: float, Usup: float, TolF: Optional[float]) -> None: ...
	@overload
	def __init__(self, P: gp_Pnt, C: Adaptor3d_Curve, TolF: Optional[float]) -> None: ...
	def Initialize(self, C: Adaptor3d_Curve, Uinf: float, Usup: float, TolF: Optional[float]) -> None: ...
	def IsDone(self) -> bool: ...
...
class Extrema_ELPCOfLocateExtPC2d:
	...
	def __init__(self) -> None: ...
	@overload
	def __init__(self, P: gp_Pnt2d, C: Adaptor2d_Curve2d, Uinf: float, Usup: float, TolF: Optional[float]) -> None: ...
	@overload
	def __init__(self, P: gp_Pnt2d, C: Adaptor2d_Curve2d, TolF: Optional[float]) -> None: ...
	def Initialize(self, C: Adaptor2d_Curve2d, Uinf: float, Usup: float, TolF: Optional[float]) -> None: ...
	def IsDone(self) -> bool: ...
	def IsMin(self, N: int) -> bool: ...
	def NbExt(self) -> int: ...
...
class Extrema_ExtCC:
	@overload
	def __init__(self, TolC1: Optional[float], TolC2: Optional[float]) -> None: ...
	@overload
	def __init__(self, C1: Adaptor3d_Curve, C2: Adaptor3d_Curve, TolC1: Optional[float], TolC2: Optional[float]) -> None: ...
	@overload
	def __init__(self, C1: Adaptor3d_Curve, C2: Adaptor3d_Curve, U1: float, U2: float, V1: float, V2: float, TolC1: Optional[float], TolC2: Optional[float]) -> None: ...
	def GetSingleSolutionFlag(self) -> bool: ...
	def IsDone(self) -> bool: ...
	def IsParallel(self) -> bool: ...
	def NbExt(self) -> int: ...
...
class Extrema_ExtCC2d:
	...
	def __init__(self) -> None: ...
	@overload
	def __init__(self, C1: Adaptor2d_Curve2d, C2: Adaptor2d_Curve2d, TolC1: Optional[float], TolC2: Optional[float]) -> None: ...
	@overload
	def __init__(self, C1: Adaptor2d_Curve2d, C2: Adaptor2d_Curve2d, U1: float, U2: float, V1: float, V2: float, TolC1: Optional[float], TolC2: Optional[float]) -> None: ...
	def GetSingleSolutionFlag(self) -> bool: ...
	def Initialize(self, C2: Adaptor2d_Curve2d, V1: float, V2: float, TolC1: Optional[float], TolC2: Optional[float]) -> None: ...
	def IsDone(self) -> bool: ...
	def IsParallel(self) -> bool: ...
	def NbExt(self) -> int: ...
...
class Extrema_ExtPS:
	...
	def __init__(self) -> None: ...
	@overload
	def __init__(self, P: gp_Pnt, S: Adaptor3d_Surface, TolU: float, TolV: float, F: Optional[Extrema_ExtFlag], A: Optional[Extrema_ExtAlgo]) -> None: ...
	@overload
	def __init__(self, P: gp_Pnt, S: Adaptor3d_Surface, Uinf: float, Usup: float, Vinf: float, Vsup: float, TolU: float, TolV: float, F: Optional[Extrema_ExtFlag], A: Optional[Extrema_ExtAlgo]) -> None: ...
...
class Extrema_GenExtPS:
	...
	def __init__(self) -> None: ...
	@overload
	def __init__(self, P: gp_Pnt, S: Adaptor3d_Surface, NbU: int, NbV: int, TolU: float, TolV: float, F: Optional[Extrema_ExtFlag], A: Optional[Extrema_ExtAlgo]) -> None: ...
	@overload
	def __init__(self, P: gp_Pnt, S: Adaptor3d_Surface, NbU: int, NbV: int, Umin: float, Usup: float, Vmin: float, Vsup: float, TolU: float, TolV: float, F: Optional[Extrema_ExtFlag], A: Optional[Extrema_ExtAlgo]) -> None: ...
...
class Extrema_GenLocateExtPS:
	def __init__(self, theS: Adaptor3d_Surface, theTolU: Optional[float], theTolV: Optional[float]) -> None: ...
	def IsDone(self) -> bool: ...
	def Perform(self, theP: gp_Pnt, theU0: float, theV0: float, isDistanceCriteria: Optional[bool]) -> None: ...
