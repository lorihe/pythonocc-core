...
class IFSelect:
	...
	@staticmethod
	def SaveSession(self, WS: IFSelect_WorkSession, file: str) -> bool: ...
...
class IFSelect_Activator(Standard_Transient):
	...
	@staticmethod
	def Adding(self, actor: IFSelect_Activator, number: int, command: str, mode: int) -> None: ...
	@staticmethod
	def Commands(self, mode: Optional[int], command: Optional[str]) -> TColStd_HSequenceOfAsciiString: ...
	def Do(self, number: int, pilot: IFSelect_SessionPilot) -> IFSelect_ReturnStatus: ...
	def File(self) -> str: ...
	def Group(self) -> str: ...
	def Help(self, number: int) -> str: ...
	@staticmethod
	def Mode(self, command: str) -> int: ...
	@staticmethod
	def Remove(self, command: str) -> None: ...
	@staticmethod
	def Select(self, command: str, actor: IFSelect_Activator) -> Tuple[bool, int]: ...
...
class IFSelect_ContextModif:
	...
	def CCheck(self, num: Optional[int]) -> Interface_Check: ...
...
class IFSelect_EditForm(Standard_Transient):
	...
	def ClearEdit(self, num: Optional[int]) -> None: ...
	...
	def Model(self) -> Interface_InterfaceModel: ...
	def Modify(self, num: int, newval: TCollection_HAsciiString, enforce: Optional[bool]) -> bool: ...
	def ModifyList(self, num: int, edited: IFSelect_ListEditor, enforce: Optional[bool]) -> bool: ...
	def ModifyListValue(self, num: int, list: TColStd_HSequenceOfHAsciiString, enforce: Optional[bool]) -> bool: ...
	...
	def PrintValues(self, S: Message_Messenger, what: int, names: bool, alsolist: Optional[bool]) -> None: ...
...
class IFSelect_Editor(Standard_Transient):
	...
	def Form(self, readonly: bool, undoable: Optional[bool]) -> IFSelect_EditForm: ...
	...
	def Name(self, num: int, isshort: Optional[bool]) -> str: ...
	def NameNumber(self, name: str) -> int: ...
	def NbValues(self) -> int: ...
	def PrintDefs(self, S: Message_Messenger, labels: Optional[bool]) -> None: ...
	def PrintNames(self, S: Message_Messenger) -> None: ...
	def Recognize(self, form: IFSelect_EditForm) -> bool: ...
	def SetList(self, num: int, max: Optional[int]) -> None: ...
	def SetValue(self, num: int, typval: Interface_TypedValue, shortname: Optional[str], accessmode: Optional[IFSelect_EditValue]) -> None: ...
...
class IFSelect_Functions:
	@staticmethod
	def GiveDispatch(self, WS: IFSelect_WorkSession, name: str, mode: Optional[bool]) -> IFSelect_Dispatch: ...
	@staticmethod
	def GiveEntity(self, WS: IFSelect_WorkSession, name: Optional[str]) -> Standard_Transient: ...
	@staticmethod
	def GiveEntityNumber(self, WS: IFSelect_WorkSession, name: Optional[str]) -> int: ...
	@staticmethod
	def GiveList(self, WS: IFSelect_WorkSession, first: Optional[str], second: Optional[str]) -> TColStd_HSequenceOfTransient: ...
	@staticmethod
	def Init(self) -> None: ...
...
class IFSelect_ListEditor(Standard_Transient):
	...
	def __init__(self) -> None: ...
	@overload
	def __init__(self, def_: Interface_TypedValue, max: Optional[int]) -> None: ...
	def AddValue(self, val: TCollection_HAsciiString, atnum: Optional[int]) -> bool: ...
	...
	def NbValues(self, edited: Optional[bool]) -> int: ...
	def OriginalValues(self) -> TColStd_HSequenceOfHAsciiString: ...
	def Remove(self, num: Optional[int], howmany: Optional[int]) -> bool: ...
	def SetTouched(self) -> None: ...
	def SetValue(self, num: int, val: TCollection_HAsciiString) -> bool: ...
	def Value(self, num: int, edited: Optional[bool]) -> TCollection_HAsciiString: ...
...
class IFSelect_SessionDumper(Standard_Transient):
	@staticmethod
	def First(self) -> IFSelect_SessionDumper: ...
...
class IFSelect_SessionFile:
	...
	def AddItem(self, item: Standard_Transient, active: Optional[bool]) -> None: ...
	...
	def WriteLine(self, line: str, follow: Optional[str]) -> None: ...
...
class IFSelect_ShareOut(Standard_Transient):
	...
	def AddModif(self, modifier: IFSelect_GeneralModifier, formodel: bool, atnum: Optional[int]) -> None: ...
	...
	def FileName(self, dnum: int, pnum: int, nbpack: Optional[int]) -> TCollection_AsciiString: ...
...
class IFSelect_ShareOutResult:
	...
	def Packets(self, complete: Optional[bool]) -> IFSelect_PacketList: ...
...
class IFSelect_Signature(Interface_SignType):
	...
	@staticmethod
	def IntValue(self, val: int) -> str: ...
	def IsIntCase(self) -> Tuple[bool, bool, int, bool, int]: ...
	def Label(self) -> TCollection_AsciiString: ...
	@staticmethod
	def MatchValue(self, val: str, text: TCollection_AsciiString, exact: bool) -> bool: ...
...
class IFSelect_SignatureList(Standard_Transient):
	def __init__(self, withlist: Optional[bool]) -> None: ...
	...
	def PrintList(self, S: Message_Messenger, model: Interface_InterfaceModel, mod: Optional[IFSelect_PrintCount]) -> None: ...
...
class IFSelect_WorkSession(Standard_Transient):
	def __init__(self) -> None: ...
	def AddItem(self, item: Standard_Transient, active: Optional[bool]) -> int: ...
	def AddNamedItem(self, name: str, item: Standard_Transient, active: Optional[bool]) -> int: ...
	...
	def CheckOne(self, ent: Standard_Transient, complete: Optional[bool]) -> Interface_CheckIterator: ...
	...
	def CombineAdd(self, selcomb: IFSelect_Selection, seladd: IFSelect_Selection, atnum: Optional[int]) -> int: ...
	def CombineRemove(self, selcomb: IFSelect_Selection, selrem: IFSelect_Selection) -> bool: ...
	def ComputeCheck(self, enforce: Optional[bool]) -> bool: ...
	def ComputeCounter(self, counter: IFSelect_SignCounter, forced: Optional[bool]) -> bool: ...
	def ComputeCounterFromList(self, counter: IFSelect_SignCounter, list: TColStd_HSequenceOfTransient, clear: Optional[bool]) -> bool: ...
	def ComputeGraph(self, enforce: Optional[bool]) -> bool: ...
	...
	def EvaluateComplete(self, mode: Optional[int]) -> None: ...
	def EvaluateDispatch(self, disp: IFSelect_Dispatch, mode: Optional[int]) -> None: ...
	...
	def Model(self) -> Interface_InterfaceModel: ...
	def ModelCheckList(self, complete: Optional[bool]) -> Interface_CheckIterator: ...
	...
	def NextIdentForLabel(self, label: str, id: int, mode: Optional[int]) -> int: ...
	def NumberFromLabel(self, val: str, afternum: Optional[int]) -> int: ...
	...
	def SendAll(self, filename: str, computegraph: Optional[bool]) -> IFSelect_ReturnStatus: ...
	def SendSelected(self, filename: str, sel: IFSelect_Selection, computegraph: Optional[bool]) -> IFSelect_ReturnStatus: ...
	def SendSplit(self) -> bool: ...
	def SentFiles(self) -> TColStd_HSequenceOfHAsciiString: ...
	def SentList(self, count: Optional[int]) -> Interface_EntityIterator: ...
	...
	def SetControl(self, sel: IFSelect_Selection, sc: IFSelect_Selection, formain: Optional[bool]) -> bool: ...
	...
	def SetModel(self, model: Interface_InterfaceModel, clearpointed: Optional[bool]) -> None: ...
	...
	def Source(self, sel: IFSelect_Selection, num: Optional[int]) -> IFSelect_Selection: ...
	...
	def TraceStatics(self, use: int, mode: Optional[int]) -> None: ...
...
class IFSelect_Act(IFSelect_Activator):
	...
	@staticmethod
	def AddFSet(self, name: str, help: str, func: IFSelect_ActFunc) -> None: ...
	@staticmethod
	def AddFunc(self, name: str, help: str, func: IFSelect_ActFunc) -> None: ...
	def Do(self, number: int, pilot: IFSelect_SessionPilot) -> IFSelect_ReturnStatus: ...
	def Help(self, number: int) -> str: ...
	@staticmethod
	def SetGroup(self, group: str, file: Optional[str]) -> None: ...
...
class IFSelect_CheckCounter(IFSelect_SignatureList):
	def __init__(self, withlist: Optional[bool]) -> None: ...
	def Analyse(self, list: Interface_CheckIterator, model: Interface_InterfaceModel, original: Optional[bool], failsonly: Optional[bool]) -> None: ...
...
class IFSelect_ParamEditor(IFSelect_Editor):
	def __init__(self, nbmax: Optional[int], label: Optional[str]) -> None: ...
	...
	def Recognize(self, form: IFSelect_EditForm) -> bool: ...
	@staticmethod
	def StaticEditor(self, list: TColStd_HSequenceOfHAsciiString, label: Optional[str]) -> IFSelect_ParamEditor: ...
	def StringValue(self, form: IFSelect_EditForm, num: int) -> TCollection_HAsciiString: ...
...
class IFSelect_SelectCombine(IFSelect_Selection):
	def Add(self, sel: IFSelect_Selection, atnum: Optional[int]) -> None: ...
	def FillIterator(self, iter: IFSelect_SelectionIterator) -> None: ...
...
class IFSelect_SessionPilot(IFSelect_Activator):
	...
	def CommandPart(self, numarg: Optional[int]) -> str: ...
	...
	def ExecuteCounter(self, counter: IFSelect_SignCounter, numword: int, mode: Optional[IFSelect_PrintCount]) -> IFSelect_ReturnStatus: ...
	def Help(self, number: int) -> str: ...
...
class IFSelect_SignCounter(IFSelect_SignatureList):
	@overload
	def __init__(self, withmap: Optional[bool], withlist: Optional[bool]) -> None: ...
	@overload
	def __init__(self, matcher: IFSelect_Signature, withmap: Optional[bool], withlist: Optional[bool]) -> None: ...
	...
	def ComputeSelected(self, G: Interface_Graph, forced: Optional[bool]) -> bool: ...
...
class IFSelect_SignMultiple(IFSelect_Signature):
	...
	def Add(self, subsign: IFSelect_Signature, width: Optional[int], maxi: Optional[bool]) -> None: ...
	def Matches(self, ent: Standard_Transient, model: Interface_InterfaceModel, text: TCollection_AsciiString, exact: bool) -> bool: ...
	def Value(self, ent: Standard_Transient, model: Interface_InterfaceModel) -> str: ...

class IFSelect_SignType(IFSelect_Signature):
	def __init__(self, nopk: Optional[bool]) -> None: ...
	def Value(self, ent: Standard_Transient, model: Interface_InterfaceModel) -> str: ...

class IFSelect_SignValidity(IFSelect_Signature):
	def __init__(self) -> None: ...
	@staticmethod
	def CVal(self, ent: Standard_Transient, model: Interface_InterfaceModel) -> str: ...
	def Value(self, ent: Standard_Transient, model: Interface_InterfaceModel) -> str: ...

class IFSelect_TransformStandard(IFSelect_Transformer):
	def __init__(self) -> None: ...
	def AddModifier(self, modif: IFSelect_Modifier, atnum: Optional[int]) -> bool: ...
...
class IFSelect_ModifReorder(IFSelect_Modifier):
	def __init__(self, rootlast: Optional[bool]) -> None: ...
	def Label(self) -> TCollection_AsciiString: ...
	def Perform(self, ctx: IFSelect_ContextModif, target: Interface_InterfaceModel, protocol: Interface_Protocol, TC: Interface_CopyTool) -> None: ...
...
class IFSelect_SelectSent(IFSelect_SelectExtract):
	def __init__(self, sentcount: Optional[int], atleast: Optional[bool]) -> None: ...
...
class IFSelect_SelectSignature(IFSelect_SelectExtract):
	@overload
	def __init__(self, matcher: IFSelect_Signature, signtext: str, exact: Optional[bool]) -> None: ...
	@overload
	def __init__(self, matcher: IFSelect_Signature, signtext: TCollection_AsciiString, exact: Optional[bool]) -> None: ...
	@overload
	def __init__(self, matcher: IFSelect_SignCounter, signtext: str, exact: Optional[bool]) -> None: ...
...
class IFSelect_SelectSignedShared(IFSelect_SelectExplore):
	def __init__(self, matcher: IFSelect_Signature, signtext: str, exact: Optional[bool], level: Optional[int]) -> None: ...
	def Explore(self, level: int, ent: Standard_Transient, G: Interface_Graph, explored: Interface_EntityIterator) -> bool: ...
	def ExploreLabel(self) -> TCollection_AsciiString: ...
	def IsExact(self) -> bool: ...
	def Signature(self) -> IFSelect_Signature: ...
