...
class StepData:
	...
	@staticmethod
	def HeaderProtocol(self) -> StepData_Protocol: ...
	@staticmethod
	def Init(self) -> None: ...
	@staticmethod
...
class StepData_Field:
	...
	@overload
	def __init__(self, other: StepData_Field, copy: Optional[bool]) -> None: ...
	def Arity(self) -> int: ...
	def Boolean(self, n1: Optional[int], n2: Optional[int]) -> bool: ...
	def Clear(self, kind: Optional[int]) -> None: ...
	def ClearItem(self, num: int) -> None: ...
	def CopyFrom(self, other: StepData_Field) -> None: ...
	def Entity(self, n1: Optional[int], n2: Optional[int]) -> Standard_Transient: ...
	def Enum(self, n1: Optional[int], n2: Optional[int]) -> int: ...
	def EnumText(self, n1: Optional[int], n2: Optional[int]) -> str: ...
	def Int(self) -> int: ...
	def Integer(self, n1: Optional[int], n2: Optional[int]) -> int: ...
	def IsSet(self, n1: Optional[int], n2: Optional[int]) -> bool: ...
	def ItemKind(self, n1: Optional[int], n2: Optional[int]) -> int: ...
	def Kind(self, type: Optional[bool]) -> int: ...
	def Length(self, index: Optional[int]) -> int: ...
	def Logical(self, n1: Optional[int], n2: Optional[int]) -> StepData_Logical: ...
	def Lower(self, index: Optional[int]) -> int: ...
	def Real(self, n1: Optional[int], n2: Optional[int]) -> float: ...
	def Set(self, val: Standard_Transient) -> None: ...
	def SetBoolean(self, val: Optional[bool]) -> None: ...
	...
	def SetEnum(self, val: Optional[int], text: Optional[str]) -> None: ...
	...
	def SetInteger(self, val: Optional[int]) -> None: ...
	def SetInteger(self, num: int, val: int) -> None: ...
	def SetList(self, size: int, first: Optional[int]) -> None: ...
	def SetList2(self, siz1: int, siz2: int, f1: Optional[int], f2: Optional[int]) -> None: ...
	def SetLogical(self, val: Optional[StepData_Logical]) -> None: ...
	def SetLogical(self, num: int, val: StepData_Logical) -> None: ...
	def SetReal(self, val: Optional[float]) -> None: ...
	...
	def String(self, n1: Optional[int], n2: Optional[int]) -> str: ...
...
class StepData_PDescr(Standard_Transient):
	def __init__(self) -> None: ...
	def AddArity(self, arity: Optional[int]) -> None: ...
	...
	def Name(self) -> str: ...
	def SetArity(self, arity: Optional[int]) -> None: ...
	def SetBoolean(self) -> None: ...
	def SetDerived(self, der: Optional[bool]) -> None: ...
	...
	def SetOptional(self, opt: Optional[bool]) -> None: ...
...
class StepData_Protocol(Interface_Protocol):
	...
	def BasicDescr(self, name: str, anylevel: Optional[bool]) -> StepData_EDescr: ...
	def CaseNumber(self, obj: Standard_Transient) -> int: ...
	def Descr(self, num: int) -> StepData_EDescr: ...
	def Descr(self, name: str, anylevel: Optional[bool]) -> StepData_EDescr: ...
	def DescrNumber(self, adescr: StepData_EDescr) -> int: ...
	def ECDescr(self, names: TColStd_SequenceOfAsciiString, anylevel: Optional[bool]) -> StepData_ECDescr: ...
	def ESDescr(self, name: str, anylevel: Optional[bool]) -> StepData_ESDescr: ...
	...
	def PDescr(self, name: str, anylevel: Optional[bool]) -> StepData_PDescr: ...
...
class StepData_StepDumper:
	def __init__(self, amodel: StepData_StepModel, protocol: StepData_Protocol, mode: Optional[int]) -> None: ...
...
class StepData_StepReaderData(Interface_FileReaderData):
	...
	def AddStepParam(self, num: int, aval: str, atype: Interface_ParamType, nument: Optional[int]) -> None: ...
	def CType(self, num: int) -> str: ...
	def CheckDerived(self, num: int, nump: int, mess: str, ach: Interface_Check, errstat: Optional[bool]) -> bool: ...
	...
	def ReadSubList(self, num: int, nump: int, mess: str, ach: Interface_Check, optional: Optional[bool], lenmin: Optional[int], lenmax: Optional[int]) -> Tuple[bool, int]: ...
	...
	def SetEntityNumbers(self, withmap: Optional[bool]) -> None: ...
...
class StepData_StepReaderTool(Interface_FileReaderTool):
	...
	def Prepare(self, optimize: Optional[bool]) -> None: ...
	def Prepare(self, reco: StepData_FileRecognizer, optimize: Optional[bool]) -> None: ...
...
class StepData_StepWriter:
	...
	def SendModel(self, protocol: StepData_Protocol, headeronly: Optional[bool]) -> None: ...
...
class StepData_WriterLib:
	...
	@staticmethod
	def SetGlobal(self, amodule: StepData_ReadWriteModule, aprotocol: StepData_Protocol) -> None: ...
	def Start(self) -> None: ...
