...
class Geom2d_OffsetCurve(Geom2d_Curve):
	def __init__(self, C: Geom2d_Curve, Offset: float, isNotCheckC0: Optional[bool]) -> None: ...
	...
	def Reverse(self) -> None: ...
	def ReversedParameter(self, U: float) -> float: ...
	def SetBasisCurve(self, C: Geom2d_Curve, isNotCheckC0: Optional[bool]) -> None: ...
...
class Geom2d_BSplineCurve(Geom2d_BoundedCurve):
	@overload
	def __init__(self, Poles: TColgp_Array1OfPnt2d, Knots: TColStd_Array1OfReal, Multiplicities: TColStd_Array1OfInteger, Degree: int, Periodic: Optional[bool]) -> None: ...
	@overload
	def __init__(self, Poles: TColgp_Array1OfPnt2d, Weights: TColStd_Array1OfReal, Knots: TColStd_Array1OfReal, Multiplicities: TColStd_Array1OfInteger, Degree: int, Periodic: Optional[bool]) -> None: ...
	def Continuity(self) -> GeomAbs_Shape: ...
	def Copy(self) -> Geom2d_Geometry: ...
	def D0(self, U: float, P: gp_Pnt2d) -> None: ...
	def D1(self, U: float, P: gp_Pnt2d, V1: gp_Vec2d) -> None: ...
	...
	def InsertKnot(self, U: float, M: Optional[int], ParametricTolerance: Optional[float]) -> None: ...
	...
	def InsertPoleAfter(self, Index: int, P: gp_Pnt2d, Weight: Optional[float]) -> None: ...
	def InsertPoleBefore(self, Index: int, P: gp_Pnt2d, Weight: Optional[float]) -> None: ...
	def IsCN(self, N: int) -> bool: ...
	def IsClosed(self) -> bool: ...
...
class Geom2d_Circle(Geom2d_Conic):
	...
	@overload
	def __init__(self, A: gp_Ax2d, Radius: float, Sense: Optional[bool]) -> None: ...
	@overload
...
class Geom2d_TrimmedCurve(Geom2d_BoundedCurve):
	def __init__(self, C: Geom2d_Curve, U1: float, U2: float, Sense: Optional[bool], theAdjustPeriodic: Optional[bool]) -> None: ...
	def BasisCurve(self) -> Geom2d_Curve: ...
	def Continuity(self) -> GeomAbs_Shape: ...
	def Copy(self) -> Geom2d_Geometry: ...
	def D0(self, U: float, P: gp_Pnt2d) -> None: ...
